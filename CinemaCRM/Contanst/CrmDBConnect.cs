...
public class CrmDBConnect
{
    static SqlConnection _connection;
    public static SqlConnection GetConnection()
    {
        _connection = new SqlConnection(Contanst.CrmConnection);
    ...
    public DataTable myTable(string strQuerry)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand(strQuerry, CrmDBConnect.GetConnection());
    ...
    public DataTable myTable(string store, params object[] paramater)
    {
        ...
        SqlCommand myCon = new SqlCommand(store, CrmDBConnect.GetConnection());
    ...
    public DataTable executeQuery(string store, params object[] paramater)
    {
        ...
        using (SqlConnection connection = new SqlConnection(Contanst.CrmConnection))
        {
    ...
    {
        SqlCommand command = new SqlCommand(strQuery, new SqlConnection(Contanst.CrmConnection));
        for (int i = 0; i < paramater.Length; i += 2)
        {
            command.Parameters.Add(paramater[i].ToString(), paramater[i + 1]);
        }
    ...
    {
        SqlCommand command = new SqlCommand(store, CrmDBConnect.GetConnection());
    ...
    public static DataSet Fill(DataSet table, String sql, params Object[] parameters)
    {
        ...
        {
            connection.Open();
            SqlCommand command = CrmDBConnect.CreateCommand(sql, parameters);
            command.Connection = connection;
    ...
    {
        return CrmDBConnect.Fill(new DataSet(), sql, parameters);
    }
    ...
    private static SqlCommand CreateCommand(String sql, params Object[] parameters)
    {
        ...
        SqlCommand command = new SqlCommand(sql, CrmDBConnect.GetConnection());
